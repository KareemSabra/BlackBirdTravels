...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)){
    ...
    if (empty($error) ) {
      $query = mysqli_query($con, "INSERT INTO `Customers`(`Name`, `Faculty`, `University`, `ParentNumber`, `MobileNumber`,`Email`, `Package`, `Pin`, `ImageURL`) VALUES ('$name','$faculty','$university','$parentnum','$phonenum','$email','once','$pin','$target_file')");


      // the message
      $msg = "A one time ticket was booked by:\nName: " .$name.
      ...
      // send email
      mail("blackbirdtravel567@gmail.com","One Use Ticket",$msg);
   ...
   // send email
   mail("$email","Welcome To Black Bird Travels",$msg2);
    ...
    <div class="container-fluid">
        <div class="row signup-page">
            <div class="col-md-12 col-sm-12">
              <h1 class="title" style="display: <?php echo $visibility2 ?>">Book a one time ticket</h1>

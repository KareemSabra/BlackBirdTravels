...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if (empty($error)) {
      ...
      $query = mysqli_query($con, "DELETE FROM `Permissions` WHERE UserName = '$target'");
...
// Close connection
mysqli_close($con);
header("location: managersview.php");
...
<html lang="en">
          ...
          <div class="row">
              <div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 width-100">
                  <form action="" method="post">
                      <div class="loginpage">
                          <input class="form-control placeholder-fix" type="text" placeholder="Username for record to delete" name="uname" required="">
                      </div>
  ...
  <div class="row">
    <table style="overflow: auto; margin-top: 5%; padding: 5%;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        $count = 0;
        $query = mysqli_query($con, $sql = "SELECT * FROM Permissions WHERE Permission = 'manager'");

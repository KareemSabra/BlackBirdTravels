...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)){
    ...
    if (empty($error) ) {
      $query = mysqli_query($con, "INSERT INTO `Customers`(`Name`, `Faculty`, `University`, `ParentNumber`, `MobileNumber`,`Email`, `Package`, `Pin`, `ImageURL`) VALUES ('$name','$faculty','$university','$parentnum','$phonenum','$email','twice','$pin','$target_file')");
    ...
    <div class="container-fluid">
        <div class="row signup-page">
            <div class="col-md-12 col-sm-12">
              <h1 class="title" style="display: <?php echo $visibility2 ?>">Book a round trip</h1>

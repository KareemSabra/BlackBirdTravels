...
$query = mysqli_query($con, "SELECT co from Permissions Where UserName = '$uname'");
    ...
    if (strlen($_POST["password"]) < 8) {
        $error .= '<p class="error" style= "color:Red">Your Password Must Contain At Least 8 Characters!</p>';
    }
...
if($count > 0){
    ...
    if (empty($error) ) {
      $query = mysqli_query($con, "INSERT INTO `Permissions`(`UserName`, `Password`, `Permission`) VALUES ('$uname','$password','manager')");
    ...
    <div class="container-fluid">
        <div class="row signup-page">
            <div class="col-md-12 col-sm-12">
                <h1 class="title">Add a new Manager</h1>
